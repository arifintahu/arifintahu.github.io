  ...
  <div class="modal" :class="{ 'd-flex': show }">
    ...
    <div class="modal-card">
      <header class="modal-card-head has-background-white">
        <p class="modal-card-title has-text-left">Pinterest Clone</p>
      ...
      <section class="modal-card-body">
        ...
        <p class="body-skill has-text-justified">
          Skills: <span class="has-text-weight-bold">ReactJS, GraphQL Apollo, Sequelize ORM, MySQL, NodeJS, ExpressJS, Styled Components, TypeScript, JavaScript, Google OAUTH, Cloudinary</span>
        </p>
        <div class="body-image">
          <img src="https://cdn.mos.cms.futurecdn.net/jU8HAQWqxPMgH3g6qSbA5.jpg" alt="Placeholder image">
          <img src="https://cdn.mos.cms.futurecdn.net/jU8HAQWqxPMgH3g6qSbA5.jpg" alt="Placeholder image">
        </div>
      </section>
